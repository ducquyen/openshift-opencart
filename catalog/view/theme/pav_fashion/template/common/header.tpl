...
<body id="offcanvas-container" class="offcanvas-container keep-header layout-<?php echo $layoutMode; ?> fs<?php echo $themeConfig['fontsize'];?> <?php echo $helper->getPageClass();?> <?php echo $helper->getParam('body_pattern','');?>">
		...
		<section id="header-main">
			<div class="container">
				<div class="row header-wrap">
					<div class="col-lg-12 col-md-4 col-sm-12 col-xs-12 inner">
