...
<section id="footer">
	...
	<div class="footer-center">
		<div class="container"><div class="inner">
			...
			<div class="row">
		  		<?php if( isset($themeConfig['call_us_data'][$LANGUAGE_ID]) ) { ?>
				<div class="column col-xs-12 col-sm-6 col-lg-3 col-md-3">
					<div class="box call-us">
						<div class="box-heading"><span><?php echo $this->language->get('text_call_us'); ?></span></div>
						<?php echo html_entity_decode( $themeConfig['call_us_data'][$LANGUAGE_ID], ENT_QUOTES, 'UTF-8' ); ?>
					</div>
				</div>
				 <?php } ?>
				...
				<div class="column col-xs-12 col-sm-6 col-lg-3 col-md-3">
					<div class="box contact-us">
						...
						<?php echo html_entity_decode( $themeConfig['contact_us_data'][$LANGUAGE_ID], ENT_QUOTES, 'UTF-8' ); ?>
					</div>
				</div>
